export function getPremiumTemplate(data) {
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://store.primadev.id";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #070d17; border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 16px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 36px 24px 24px; text-align: center; border-bottom: 1px solid rgba(255, 255, 255, 0.08);">
              <img src="${logoUrl}" alt="Primadev" width="150" style="display: inline-block; margin-bottom: 18px; filter: brightness(0) invert(1); -webkit-filter: brightness(0) invert(1); max-width: 150px; height: auto;" />
          ...
          <tr>
            <td style="padding: 32px 28px;">
              <p style="margin: 0 0 16px 0; font-size: 16px; color: #ffffff !important; line-height: 1.5;">
                Halo <strong style="color: #F5A623 !important; font-weight: 700;">${data.name}</strong>,
              </p>
              ...
              <!-- LICENSE KEY BOX -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #0c1424; border: 2px dashed #F5A623; border-radius: 12px; margin-bottom: 28px;">
                <tr>
                  <td style="padding: 24px; text-align: center;">
                    ...
                    <div style="font-family: 'Courier New', Courier, monospace; font-size: 22px; font-weight: 800; color: #F5A623 !important; letter-spacing: 2px; word-break: break-all;">
                      ${data.key}
                    </div>
              ...
              <div style="text-align: center; margin-top: 32px;">
                <a href="${siteUrl}/api/invoice?id=${data.key}" target="_blank" style="display: inline-block; background-color: #F5A623 !important; color: #000000 !important; font-weight: 800; padding: 13px 32px; border-radius: 8px; text-decoration: none; font-size: 14px;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #070d17; border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 16px; overflow: hidden;">
          ...
          <tr>
            <td style="padding: 32px 28px;">
              ...
              <!-- LICENSE KEY BOX -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #0c1424; border: 2px dashed #1a6dff; border-radius: 12px; margin-bottom: 28px;">
                <tr>
                  <td style="padding: 24px; text-align: center;">
                    <div style="font-size: 11.5px; text-transform: uppercase; letter-spacing: 2px; color: #94a3b8 !important; font-weight: 700; margin-bottom: 8px;">
                      LICENSE KEY ANDA
                    </div>
                    <div style="font-family: 'Courier New', Courier, monospace; font-size: 22px; font-weight: 800; color: #1a6dff !important; letter-spacing: 2px; word-break: break-all;">
                      ${data.key}
                    </div>
                  </td>
                </tr>
              ...
              <!-- CTA BUTTON -->
              <div style="text-align: center; margin-top: 32px;">
                <a href="${siteUrl}/api/invoice?id=${data.key}" target="_blank" style="display: inline-block; background-color: #1a6dff !important; color: #ffffff !important; font-weight: 800; padding: 13px 32px; border-radius: 8px; text-decoration: none; font-size: 14px;">
